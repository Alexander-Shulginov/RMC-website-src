	...
	for (let s = 1; s < arguments.length; s += 1) {
		...
		if (null != a && !isNode(a)) {
			...
			for (let t = 0, i = s.length; t < i; t += 1) {
				...
				void 0 !== r &&
					r.enumerable &&
					(isObject(e[i]) && isObject(a[i]) ? (a[i].__swiper__ ? (e[i] = a[i]) : extend(e[i], a[i])) : !isObject(e[i]) && isObject(a[i]) ? ((e[i] = {}), a[i].__swiper__ ? (e[i] = a[i]) : extend(e[i], a[i])) : (e[i] = a[i]));
			}
		}
	}
	return e;
...
function updateSize() {
	...
	(t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : a.clientWidth),
		...
		(0 === t && e.isHorizontal()) ||
			(0 === s && e.isVertical()) ||
			((t = t - parseInt(elementStyle(a, "padding-left") || 0, 10) - parseInt(elementStyle(a, "padding-right") || 0, 10)),
			(s = s - parseInt(elementStyle(a, "padding-top") || 0, 10) - parseInt(elementStyle(a, "padding-bottom") || 0, 10)),
			Number.isNaN(t) && (t = 0),
			Number.isNaN(s) && (s = 0),
...
function updateSlides() {
	...
	for (let i = 0; i < u; i += 1) {
		...
		if (((M = 0), p[i] && (r = p[i]), T && e.grid.updateSlide(i, r, u, t), !p[i] || "none" !== elementStyle(r, "display"))) {
			if ("auto" === a.slidesPerView) {
				...
				if ((l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), a.roundLengths)) M = e.isHorizontal() ? elementOuterSize(r, "width", !0) : elementOuterSize(r, "height", !0);
				else {
					const e = s(n, "width"),
						t = s(n, "padding-left"),
						a = s(n, "padding-right"),
			...
			p[i] && (p[i].swiperSlideSize = M),
				h.push(M),
				a.centeredSlides
					? ((E = E + M / 2 + S / 2 + y), 0 === S && 0 !== i && (E = E - n / 2 - y), 0 === i && (E = E - n / 2 - y), Math.abs(E) < 0.001 && (E = 0), a.roundLengths && (E = Math.floor(E)), x % a.slidesPerGroup == 0 && m.push(E), f.push(E))
					: (a.roundLengths && (E = Math.floor(E)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && m.push(E), f.push(E), (E = E + M + y)),
				(e.virtualSize += M + y),
				(S = M),
				(x += 1);
		}
	...
	if (
		...
		m.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")),
...
function updateProgress(e) {
	...
	if (s.loop) {
		const s = elementIndex(t.slides.filter((e) => "0" === e.getAttribute("data-swiper-slide-index"))[0]),
			a = elementIndex(t.slides.filter((e) => 1 * e.getAttribute("data-swiper-slide-index") == t.slides.length - 1)[0]),
			i = t.slidesGrid[s],
			r = t.slidesGrid[a],
...
function updateActiveIndex(e) {
	...
	if ((void 0 === d && (d = getActiveIndexByTranslate(t)), a.indexOf(s) >= 0)) o = a.indexOf(s);
	else {
...
function setTranslate(e, t) {
	...
	s.isHorizontal() ? (l = a ? -e : e) : (o = e),
		...
		i.cssMode ? (r[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -l : -o) : i.virtualTranslate || (r.style.transform = `translate3d(${l}px, ${o}px, 0px)`),
...
function slideToLoop(e, t, s, a) {
	...
	const i = this;
	let r = e;
	return i.params.loop && (i.virtual && i.params.virtual.enabled ? (r += i.virtual.slidesBefore) : (r = elementIndex(i.slides.filter((e) => 1 * e.getAttribute("data-swiper-slide-index") === r)[0]))), i.slideTo(r, t, s, a);
}
...
function slidePrev(e, t, s) {
	...
	let h = 0;
	if (
		(void 0 !== f && ((h = n.indexOf(f)), h < 0 && (h = a.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && ((h = h - a.slidesPerViewDynamic("previous", !0) + 1), (h = Math.max(h, 0)))),
		...
		(i = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
			t.centeredSlides
				? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2
					? (e.loopFix(),
					  (r = elementIndex(elementChildren(s, `${n}[data-swiper-slide-index="${i}"]`)[0])),
					  nextTick(() => {
							e.slideTo(r);
					  }))
					: e.slideTo(r)
...
function loopFix(e) {
	...
	const g = [],
		v = [];
	let w = o.activeIndex;
	void 0 === r ? (r = elementIndex(o.slides.filter((e) => e.classList.contains("swiper-slide-active"))[0])) : (w = r);
	const b = "next" === a || !a,
		y = "prev" === a || !a;
	let E = 0,
		S = 0;
...
function onTouchMove(e) {
	...
	if (!s.allowTouchMove)
		return o.target.matches(a.focusableElements) || (s.allowClick = !1), void (a.isTouched && (Object.assign(r, { startX: p, startY: u, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: p, currentY: u }), (a.touchStartTime = now())));
	...
	if (void 0 === a.isScrolling) {
		...
		(s.isHorizontal() && r.currentY === r.startY) || (s.isVertical() && r.currentX === r.startX)
			? (a.isScrolling = !1)
			: m * m + f * f >= 25 && ((e = (180 * Math.atan2(Math.abs(f), Math.abs(m))) / Math.PI), (a.isScrolling = s.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle));
	}
	if (
	...
	let b;
	a.isMoved && v !== s.touchesDirection && w && Math.abs(h) >= 1 && (s.loopFix({ direction: s.swipeDirection, setTranslate: !0 }), (b = !0)), s.emit("sliderMove", o), (a.isMoved = !0), (a.currentTranslate = h + a.startTranslate);
	let y = !0,
		E = i.resistanceRatio;
	if (
		(i.touchReleaseOnEdges && (E = 0),
		h > 0
			? (w && !b && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
			  a.currentTranslate > s.minTranslate() && ((y = !1), i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + h) ** E)))
			: h < 0 &&
			  (w &&
					!b &&
			  ...
			  a.currentTranslate < s.maxTranslate() && ((y = !1), i.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - h) ** E))),
...
function onTouchEnd(e) {
	...
	if (p > i.longSwipesMs) {
		...
		"next" === t.swipeDirection && (v >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? h : m + w) : t.slideTo(m)),
			"prev" === t.swipeDirection && (v > 1 - i.longSwipesRatio ? t.slideTo(m + w) : null !== g && v < 0 && Math.abs(v) > i.longSwipesRatio ? t.slideTo(g) : t.slideTo(m));
	} else {
		...
		t.navigation && (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl)
			? d.target === t.navigation.nextEl
				? t.slideTo(m + w)
				: t.slideTo(m)
			: ("next" === t.swipeDirection && t.slideTo(null !== h ? h : m + w), "prev" === t.swipeDirection && t.slideTo(null !== g ? g : m));
	}
}
let timeout;
function onResize() {
...
const events = (e, t) => {
	...
	i[o]("pointerdown", e.onTouchStart, { passive: !1 }),
		...
		a.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", onResize, !0) : e[d]("observerUpdate", onResize, !0),
...
function attachEvents() {
	...
	(e.onTouchStart = onTouchStart.bind(e)),
		...
		dummyEventAttached || (t.addEventListener("touchstart", dummyEventListener), (dummyEventAttached = !0)),
		events(e, "on");
}
	...
	return function (s) {
		...
		"object" == typeof i && null !== i
			? (["navigation", "pagination", "scrollbar"].indexOf(a) >= 0 && !0 === e[a] && (e[a] = { auto: !0 }),
			  a in e && "enabled" in i ? (!0 === e[a] && (e[a] = { enabled: !0 }), "object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), extend(t, s)) : extend(t, s))
			: extend(t, s);
	};
}
const prototypes = {
...
class Swiper {
	constructor() {
		...
		const l = {};
		n.modules.forEach((e) => {
			e({ params: t, swiper: n, extendParams: moduleExtendParams(t, l), on: n.on.bind(n), once: n.once.bind(n), off: n.off.bind(n), emit: n.emit.bind(n) });
		});
...
function Virtual(e) {
	...
	function o(e, t) {
		...
		let i;
		return (
			a.renderSlide ? ((i = a.renderSlide.call(s, e, t)), "string" == typeof i && ((l.innerHTML = i), (i = l.children[0]))) : (i = s.isElement ? createElement("swiper-slide") : createElement("div", s.params.slideClass)),
	...
	function d(e) {
		...
		if (
			(n && h >= w ? ((b -= w), i || (E += s.slidesGrid[0])) : n && h < w && ((b = -w), i && (E += s.slidesGrid[0])),
			Object.assign(s.virtual, { from: b, to: y, offset: E, slidesGrid: s.slidesGrid, slidesBefore: w, slidesAfter: v }),
			c === b && p === y && !e)
		)
			return (
				s.slidesGrid !== m &&
...
function Mousewheel(e) {
	...
	function u(e) {
		return (
			...
			!(t.params.mousewheel.thresholdTime && now() - o < t.params.mousewheel.thresholdTime) &&
			((e.delta >= 6 && now() - o < 60) ||
				(e.direction < 0 ? (t.isEnd && !t.params.loop) || t.animating || (t.slideNext(), i("scroll", e.raw)) : (t.isBeginning && !t.params.loop) || t.animating || (t.slidePrev(), i("scroll", e.raw)), (o = new r.Date().getTime()), !1))
		);
	}
	function m(e) {
		let s = e,
		...
		if (
			...
			if (!a) {
				...
				if (
					...
					n ||
						(n = nextTick(() => {
							(l = e), d.splice(0), t.slideToClosest(t.params.speed, !0, void 0, 0.5);
						}, 500));
				}
...
function Pagination(e) {
	...
	function u() {
		...
		if (
			...
			if (
				(s.dynamicBullets &&
					((n = elementOuterSize(i[0], t.isHorizontal() ? "width" : "height", !0)),
					r.forEach((e) => {
		...
		r.forEach((e, r) => {
			if (
				("fraction" === s.type &&
					(e.querySelectorAll(classesToSelector(s.currentClass)).forEach((e) => {
				...
				"horizontal" === i ? (n = r) : (l = r),
					e.querySelectorAll(classesToSelector(s.progressbarFillClass)).forEach((e) => {
	...
	function m() {
		...
		"fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`),
			...
			a.forEach((s) => {
				"custom" !== e.type && (s.innerHTML = r || ""), "bullets" === e.type && (t.pagination.bullets = [...s.querySelectorAll(classesToSelector(e.bulletClass))]);
			}),
	...
	function f() {
		...
		"string" == typeof e.el && t.isElement && (s = t.el.shadowRoot.querySelector(e.el)),
			...
			s &&
				0 !== s.length &&
				(t.params.uniqueNavElements && "string" == typeof e.el && Array.isArray(s) && s.length > 1 && ((s = [...t.el.querySelectorAll(e.el)]), s.length > 1 && (s = s.filter((e) => elementParents(e, ".swiper")[0] === t.el)[0])),
...
function Scrollbar(e) {
	...
	function m() {
		...
		s ? ((c = -c), c > 0 ? ((d = l - c), (c = 0)) : -c + l > o && (d = o + c)) : c < 0 ? ((d = l + c), (c = 0)) : c + l > o && (d = o - c),
			t.isHorizontal() ? ((a.style.transform = `translate3d(${c}px, 0, 0)`), (a.style.width = `${d}px`)) : ((a.style.transform = `translate3d(0px, ${c}px, 0)`), (a.style.height = `${d}px`)),
			r.hide &&
				(clearTimeout(p),
				(i.style.opacity = 1),
				(p = setTimeout(() => {
	...
	function f() {
		...
		(s.style.width = ""),
			...
			(l = "auto" === t.params.scrollbar.dragSize ? o * d : parseInt(t.params.scrollbar.dragSize, 10)),
	...
	function v(e) {
		const s = t.params.scrollbar,
			...
			{ el: l, dragEl: o } = a;
		(c = !0),
			(n = e.target === o ? h(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null),
			e.preventDefault(),
			e.stopPropagation(),
	...
	function E() {
		...
		"string" == typeof a.el && t.isElement && (i = t.el.shadowRoot.querySelector(a.el)),
			i || "string" != typeof a.el ? i || (i = a.el) : (i = r.querySelectorAll(a.el)),
			t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)),
			i.length > 0 && (i = i[0]),
			i.classList.add(t.isHorizontal() ? a.horizontalClass : a.verticalClass),
			i && (i.querySelector(`.${t.params.scrollbar.dragClass}`), n || ((n = createElement("div", t.params.scrollbar.dragClass)), i.append(n))),
...
function Zoom(e) {
	...
	let n,
		...
		d = !1;
	const c = [],
		p = { slideEl: void 0, slideWidth: void 0, slideHeight: void 0, imageEl: void 0, imageWrapEl: void 0, maxRatio: 3 },
	...
	function v(e) {
		...
		if (((n = !1), (l = !1), c.push(e), !(c.length < 2))) {
			if (((n = !0), (p.scaleStart = h()), !p.slideEl)) {
				...
				if ((a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (p.imageEl = a), (p.imageWrapEl = a ? elementParents(p.imageEl, `.${s.containerClass}`)[0] : void 0), !p.imageWrapEl))
	...
	function E() {
		...
		p.slideEl &&
			...
			(p.imageEl && (p.imageEl.style.transform = "translate3d(0,0,0) scale(1)"), p.imageWrapEl && (p.imageWrapEl.style.transform = "translate3d(0,0,0)"), (e.scale = 1), (o = 1), (p.slideEl = void 0), (p.imageEl = void 0), (p.imageWrapEl = void 0));
	}
	function S(e) {
		const s = t.zoom,
			a = t.params.zoom;
		if (!p.slideEl) {
			e && e.target && (p.slideEl = e.target.closest(`.${t.params.slideClass}, swiper-slide`)),
				p.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? (p.slideEl = elementChildren(t.slidesEl, `.${t.params.slideActiveClass}`)[0]) : (p.slideEl = t.slides[t.activeIndex]));
		...
		t.params.cssMode && ((t.wrapperEl.style.overflow = "hidden"), (t.wrapperEl.style.touchAction = "none")),
			...
			void 0 === u.touchesStart.x && e ? ((i = e.pageX), (n = e.pageY)) : ((i = u.touchesStart.x), (n = u.touchesStart.y));
	...
	Object.defineProperty(t.zoom, "scale", {
		...
		a("touchStart", (e, s) => {
			t.zoom.enabled &&
				(function (e) {
					const s = t.device;
					p.imageEl && (u.isTouched || (s.android && e.cancelable && e.preventDefault(), (u.isTouched = !0), (u.touchesStart.x = e.pageX), (u.touchesStart.y = e.pageY)));
				})(s);
		}),
		a("touchEnd", (e, s) => {
			t.zoom.enabled &&
...
function A11y(e) {
	...
	function f(e) {
		...
		const s = t.params.a11y,
			a = e.target;
		(t.pagination && t.pagination.el && (a === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(classesToSelector(t.params.pagination.bulletClass))) ||
			...
			t.pagination && a.matches(classesToSelector(t.params.pagination.bulletClass)) && a.click());
	}
	function h() {
				...
				(function () {
					...
					h() &&
						t.pagination.bullets.forEach((s) => {
							t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, elementIndex(s) + 1)))),
								s.matches(`.${t.params.pagination.bulletActiveClass}`) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current");
						});
				})();
		}),
		a("destroy", () => {
...
function HashNavigation(e) {
	...
	const o = () => {
			...
			if (e !== t.slides[t.activeIndex].getAttribute("data-hash")) {
				const s = elementIndex(elementChildren(t.slidesEl, `.${t.params.slideClass}[data-hash="${e}"], swiper-slide[data-hash="${e}"]`)[0]);
				if (void 0 === s) return;
				t.slideTo(s);
			}
		},
		d = () => {
			if (r && t.params.hashNavigation.enabled)
				if (t.params.hashNavigation.replaceState && l.history && l.history.replaceState) l.history.replaceState(null, null, `#${t.slides[t.activeIndex].getAttribute("data-hash")}` || ""), a("hashSet");
				else {
...
function Autoplay(e) {
	...
	(a.autoplay = { running: !1, paused: !1, timeLeft: 0 }), i({ autoplay: { enabled: !1, delay: 3e3, waitForTransition: !0, disableOnInteraction: !0, stopOnLastSlide: !1, reverseDirection: !1, pauseOnMouseEnter: !1 } });
	let o,
		d,
		c,
		p,
				...
				d = () => {
					a.params.autoplay.reverseDirection
						? !a.isBeginning || a.params.loop || a.params.rewind
							...
							: a.params.autoplay.stopOnLastSlide || (a.slideTo(a.slides.length - 1, l, !0, !0), n("autoplay"))
						: !a.isEnd || a.params.loop || a.params.rewind
						? (a.slideNext(l, !0, !0), n("autoplay"))
						: a.params.autoplay.stopOnLastSlide || (a.slideTo(0, l, !0, !0), n("autoplay")),
						a.params.cssMode &&
							((v = new Date().getTime()),
							requestAnimationFrame(() => {
								y();
...
function Thumb(e) {
	...
	function o(e) {
		...
		if (
			...
			for (let e = 0; e < i; e += 1)
				elementChildren(s.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`).forEach((e) => {
					e.classList.add(r);
				});
		...
		Object.assign(t, {
			freeMode: {
				...
				onTouchMove: function () {
					...
					0 === e.velocities.length && e.velocities.push({ position: s[t.isHorizontal() ? "startX" : "startY"], time: e.touchStartTime }), e.velocities.push({ position: s[t.isHorizontal() ? "currentX" : "currentY"], time: now() });
				},
				onTouchEnd: function (e) {
					...
					if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
						...
						if (r.freeMode.momentum) {
							...
							let f;
							if (c < t.maxTranslate())
								r.freeMode.momentumBounce ? (c + t.maxTranslate() < -m && (c = t.maxTranslate() - m), (p = t.maxTranslate()), (u = !0), (d.allowMomentumBounce = !0)) : (c = t.maxTranslate()), r.loop && r.centeredSlides && (f = !0);
							else if (c > t.minTranslate())
								r.freeMode.momentumBounce ? (c - t.minTranslate() > m && (c = t.minTranslate() + m), (p = t.minTranslate()), (u = !0), (d.allowMomentumBounce = !0)) : (c = t.minTranslate()), r.loop && r.centeredSlides && (f = !0);
	...
	i.grid = {
		...
		updateSlide: (e, r, n, l) => {
			...
			if ("row" === p && o > 1) {
				...
				(f = Math.floor(a / i)), (m = a - f * i + s * o), (u = m + (f * t) / c), (r.style.order = u);
...
function EffectCube(e) {
	...
	const i = (e, t, s) => {
		...
		a || ((a = createElement("div", "swiper-slide-shadow-" + (s ? "left" : "top"))), e.append(a)),
			i || ((i = createElement("div", "swiper-slide-shadow-" + (s ? "right" : "bottom"))), e.append(i)),
	...
	effectInit({
		...
		setTranslate: () => {
			...
			c.shadow &&
				(p
					? ((m = t.slidesEl.querySelector(".swiper-cube-shadow")), m || ((m = createElement("div", "swiper-cube-shadow")), t.slidesEl.append(m)), (m.style.height = `${r}px`))
					: ((m = e.querySelector(".swiper-cube-shadow")), m || ((m = createElement("div", "swiper-cube-shadow")), e.append(m))));
			for (let e = 0; e < a.length; e += 1) {
				const t = a[e];
				let s = e;
	...
	effectInit({
		...
		setTranslate: () => {
			...
			for (let e = 0, t = a.length; e < t; e += 1) {
				...
				Math.abs(v) < 0.001 && (v = 0), Math.abs(g) < 0.001 && (g = 0), Math.abs(f) < 0.001 && (f = 0), Math.abs(u) < 0.001 && (u = 0), Math.abs(m) < 0.001 && (m = 0), Math.abs(w) < 0.001 && (w = 0);
...
function EffectCreative(e) {
	let { swiper: t, extendParams: s, on: a } = e;
	s({
		creativeEffect: { limitProgress: 1, shadowPerProgress: !1, progressMultiplier: 1, perspective: !0, prev: { translate: [0, 0, 0], rotate: [0, 0, 0], opacity: 1, scale: 1 }, next: { translate: [0, 0, 0], rotate: [0, 0, 0], opacity: 1, scale: 1 } },
	});
	...
	effectInit({
		...
		setTranslate: () => {
			...
			for (let s = 0; s < e.length; s += 1) {
				...
				(E.style.transform = y), (E.style.opacity = b), h.origin && (E.style.transformOrigin = b);
			}
		},
		setTransition: (e) => {
			const s = t.slides.map((e) => getSlideTransformEl(e));
		...
		setTranslate: () => {
			...
			for (let l = 0; l < e.length; l += 1) {
				...
				if (b || y) {
					...
					(g += -28 * c * e), (h += -0.5 * e), (v += 96 * e), (m = -25 * e * Math.abs(c) + "%");
				}
				...
				if (a.slideShadows) {
					...
					e || (e = createShadow(a, o)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - 0.5) / 0.5, 0), 1));
				}
